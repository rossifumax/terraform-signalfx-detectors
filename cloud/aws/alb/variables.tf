...
variable "httpcode_5xx_disabled" {
  description = "Disable all alerting rules for httpcode 5xx detector"
  type        = bool
  default     = null
}

variable "httpcode_5xx_disabled_critical" {
  description = "Disable critical alerting rule for httpcode 5xx detector"
  type        = bool
  default     = null
}

variable "httpcode_5xx_disabled_warning" {
  description = "Disable warning alerting rule for httpcode 5xx detector"
  type        = bool
  default     = null
}

variable "httpcode_5xx_notifications" {
  description = "Notification recipients list for every alerting rules of httpcode 5xx detector"
  type        = list
  default     = []
}

variable "httpcode_5xx_notifications_warning" {
  description = "Notification recipients list for warning alerting rule of httpcode 5xx detector"
  type        = list
  default     = []
}

variable "httpcode_5xx_notifications_critical" {
  description = "Notification recipients list for critical alerting rule of httpcode 5xx detector"
  type        = list
  default     = []
}

variable "httpcode_5xx_aggregation_function" {
  description = "Aggregation function and group by for httpcode 5xx detector (i.e. \".mean(by=['host'])\")"
  type        = string
  default     = ".mean(by=['aws_region','LoadBalancer'])"
}

variable "httpcode_5xx_transformation_function" {
  description = "Transformation function for httpcode 5xx detector (mean, min, max)"
  type        = string
  default     = "min"
}

variable "httpcode_5xx_transformation_window" {
  description = "Transformation window for httpcode 5xx detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "5m"
}

variable "httpcode_5xx_threshold_critical" {
  description = "Critical threshold for httpcode 5xx detector"
  type        = number
  default     = 80
}

variable "httpcode_5xx_threshold_warning" {
  description = "Warning threshold for httpcode 5xx detector"
  type        = number
  default     = 60
}
...
variable "httpcode_4xx_disabled" {
  description = "Disable all alerting rules for httpcode 4xx detector"
  type        = bool
  default     = null
}

variable "httpcode_4xx_disabled_critical" {
  description = "Disable critical alerting rule for httpcode 4xx detector"
  type        = bool
  default     = null
}

variable "httpcode_4xx_disabled_warning" {
  description = "Disable warning alerting rule for httpcode 4xx detector"
  type        = bool
  default     = null
}

variable "httpcode_4xx_notifications" {
  description = "Notification recipients list for every alerting rules of httpcode 4xx detector"
  type        = list
  default     = []
}

variable "httpcode_4xx_notifications_warning" {
  description = "Notification recipients list for warning alerting rule of httpcode 4xx detector"
  type        = list
  default     = []
}

variable "httpcode_4xx_notifications_critical" {
  description = "Notification recipients list for critical alerting rule of httpcode 4xx detector"
  type        = list
  default     = []
}

variable "httpcode_4xx_aggregation_function" {
  description = "Aggregation function and group by for httpcode 4xx detector (i.e. \".mean(by=['host'])\")"
  type        = string
  default     = ".mean(by=['aws_region','LoadBalancer'])"
}

variable "httpcode_4xx_transformation_function" {
  description = "Transformation function for httpcode 4xx detector (mean, min, max)"
  type        = string
  default     = "min"
}

variable "httpcode_4xx_transformation_window" {
  description = "Transformation window for httpcode 4xx detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "5m"
}

variable "httpcode_4xx_threshold_critical" {
  description = "Critical threshold for httpcode 4xx detector"
  type        = number
  default     = 80
}

variable "httpcode_4xx_threshold_warning" {
  description = "Warning threshold for httpcode 4xx detector"
  type        = number
  default     = 60
}
...
variable "httpcode_target_5xx_disabled" {
  description = "Disable all alerting rules for httpcode target 5xx detector"
  type        = bool
  default     = null
}

variable "httpcode_target_5xx_disabled_critical" {
  description = "Disable critical alerting rule for httpcode target 5xx detector"
  type        = bool
  default     = null
}

variable "httpcode_target_5xx_disabled_warning" {
  description = "Disable warning alerting rule for httpcode target 5xx detector"
  type        = bool
  default     = null
}

variable "httpcode_target_5xx_notifications" {
  description = "Notification recipients list for every alerting rules of httpcode target 5xx detector"
  type        = list
  default     = []
}

variable "httpcode_target_5xx_notifications_warning" {
  description = "Notification recipients list for warning alerting rule of httpcode target 5xx detector"
  type        = list
  default     = []
}

variable "httpcode_target_5xx_notifications_critical" {
  description = "Notification recipients list for critical alerting rule of httpcode target 5xx detector"
  type        = list
  default     = []
}

variable "httpcode_target_5xx_aggregation_function" {
  description = "Aggregation function and group by for httpcode target 5xx detector (i.e. \".mean(by=['host'])\")"
  type        = string
  default     = ".mean(by=['aws_region','LoadBalancer'])"
}

variable "httpcode_target_5xx_transformation_function" {
  description = "Transformation function for httpcode target 5xx detector (mean, min, max)"
  type        = string
  default     = "min"
}

variable "httpcode_target_5xx_transformation_window" {
  description = "Transformation window for httpcode target 5xx detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "5m"
}

variable "httpcode_target_5xx_threshold_critical" {
  description = "Critical threshold for httpcode target 5xx detector"
  type        = number
  default     = 80
}

variable "httpcode_target_5xx_threshold_warning" {
  description = "Warning threshold for httpcode target 5xx detector"
  type        = number
  default     = 60
}
...
variable "httpcode_target_4xx_disabled" {
  description = "Disable all alerting rules for httpcode target 4xx detector"
  type        = bool
  default     = null
}

variable "httpcode_target_4xx_disabled_critical" {
  description = "Disable critical alerting rule for httpcode target 4xx detector"
  type        = bool
  default     = null
}

variable "httpcode_target_4xx_disabled_warning" {
  description = "Disable warning alerting rule for httpcode target 4xx detector"
  type        = bool
  default     = null
}

variable "httpcode_target_4xx_notifications" {
  description = "Notification recipients list for every alerting rules of httpcode target 4xx detector"
  type        = list
  default     = []
}

variable "httpcode_target_4xx_notifications_warning" {
  description = "Notification recipients list for warning alerting rule of httpcode target 4xx detector"
  type        = list
  default     = []
}

variable "httpcode_target_4xx_notifications_critical" {
  description = "Notification recipients list for critical alerting rule of httpcode target 4xx detector"
  type        = list
  default     = []
}

variable "httpcode_target_4xx_aggregation_function" {
  description = "Aggregation function and group by for httpcode target 4xx detector (i.e. \".mean(by=['host'])\")"
  type        = string
  default     = ".mean(by=['aws_region','LoadBalancer'])"
}

variable "httpcode_target_4xx_transformation_function" {
  description = "Transformation function for httpcode target 4xx detector (mean, min, max)"
  type        = string
  default     = "min"
}

variable "httpcode_target_4xx_transformation_window" {
  description = "Transformation window for httpcode target 4xx detector (i.e. 5m, 20m, 1h, 1d)"
  type        = string
  default     = "5m"
}

variable "httpcode_target_4xx_threshold_critical" {
  description = "Critical threshold for httpcode target 4xx detector"
  type        = number
  default     = 80
}

variable "httpcode_target_4xx_threshold_warning" {
  description = "Warning threshold for httpcode target 4xx detector"
  type        = number
  default     = 60
}
